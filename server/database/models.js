...
db.sync({force: true}).then(()=>{
    ...
    Task.create({title: 'Event Usher', description:'Seat participants', organization: 'NYCares', latitude: 40.748104, longitude: -73.993922, location: '214 W 29th St, New York, NY 10001', needed: 10, volunteers: 0, dateTime: '03-06-2018 17:00'})
